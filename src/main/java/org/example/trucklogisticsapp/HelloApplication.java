...
/**
 * Main Application - Test your FXML, Controllers, and CSS
 * Run this to see your UI in action
 */
public class HelloApplication extends Application {
    ...
    /**
     * Test Main Layout with Sidebar (RECOMMENDED)
     */
    ...
    private void testTruckManagement(Stage primaryStage) throws Exception {
        ...
        // Get controller (optional - to access controller methods)
